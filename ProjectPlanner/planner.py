...
def draw_chart(tasks, canvas, row_height=40, title_width=300, line_height=40, day_width=20, bar_height=20, \
    ...
    for week_number in range(5):
        ...
        for task_number in start_days:
            ...
            canvas.create_rectangle(bar_x, bar_y, bar_x + bar_width, bar_y + bar_height, fill="#b48d73")
            y += row_height
...
canvas = tkinter.Canvas(root, width=800, height=400, bg="#345e60")
